...
class Sprites:
    def __init__(self):
        self.sprite_parameters = {
            ...
            'npc_soldier0': {
                'sprite': [pygame.image.load(os.path.join(dirname,f'sprites/npc/soldier0/base/{i}.png')).convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.8,
                'scale': (0.4, 0.6),
                'side': 30,
                'animation': [],
                'death_animation': deque([pygame.image.load(os.path.join(dirname,f'sprites/npc/soldier0/death/{i}.png'))
                ...
                'blocked': True,
                'flag': 'npc',
                'obj_action': deque([pygame.image.load(os.path.join(dirname,f'sprites/npc/soldier0/action/{i}.png'))
